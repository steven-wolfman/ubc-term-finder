...
- [Testing across node versions](https://github.com/actions/starter-workflows/blob/main/ci/node.js.yml): Uses a matrix to handle a factorial testing strategy (in this case, just different versions of Node but presumably could be multiple factors? TODO). TODO: clearer discussion of matrix and discuss the `$default-branch` syntax.
